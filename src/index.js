...
if (module.hot) {
    // 方便print.js内部发生变化时可以告诉webpack接受更新的模块
...
if (process.env.NUMBER === 1) {
    console.log('process NUMBER is 1');
}

console.log(process.env.TEST, typeof process.env.TEST);
console.log(process.env.NODE_ENV, process.env.NODE_ENV, typeof process.env.NODE_ENV);
console.log(process.env.NUMBER, process.env.NUMBER, typeof process.env.NUMBER);
